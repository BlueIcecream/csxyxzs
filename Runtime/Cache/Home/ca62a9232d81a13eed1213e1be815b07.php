...
$(document).ready(function(){
    $("button").click(function(){
      ...
      $.post("/csxyxzs-master/index.php/Home/Campus/saveCet",
        {
          'zkzh':zkzh,
          'name':name,
          'openid':openid
...
<div class="container">
  ...
  <form class="form-signin" >
    ...
    <p></p>
    <button class="btn btn-lg btn-default btn-block" type="submit">保存</button>
  ...
  <div class="row">
      <div class="col-sm-12 text-center">
        <p>我有准考证号?<a href='/csxyxzs-master/index.php/Home/Campus/queryCetView/auth/<?php echo ($auth); ?>' class="text-primary m-l-5 save" styles=""><b>点击这里查询</b></a></p>
      </div>
  </div>
